...
public:
    MMCVCumMaxKernel(Ort::CustomOpApi ort, const OrtKernelInfo* info): ort_(ort)
    {
...
public:
    MMCVCumMinKernel(Ort::CustomOpApi ort, const OrtKernelInfo* info): ort_(ort)
    {
        dim_ = ort_.KernelInfoGetAttribute<int64_t>(info, "dim");
...
struct MMCVCumMaxCustomOp: Ort::CustomOpBase<MMCVCumMaxCustomOp, MMCVCumMaxKernel> {
...
struct MMCVCumMinCustomOp: Ort::CustomOpBase<MMCVCumMinCustomOp, MMCVCumMinKernel> {
    void* CreateKernel(Ort::CustomOpApi api, const OrtKernelInfo* info) const
    {
