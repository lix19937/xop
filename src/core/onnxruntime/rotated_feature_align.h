...
public:
    MMCVRotatedFeatureAlignKernel(Ort::CustomOpApi ort, const OrtKernelInfo* info): ort_(ort)
    {
...
struct MMCVRotatedFeatureAlignCustomOp:
    Ort::CustomOpBase<MMCVRotatedFeatureAlignCustomOp, MMCVRotatedFeatureAlignKernel> {
    ...
    {
        return "MMCVRotatedFeatureAlign";
    }
